...
## WISE authentication (test setup)

Set `WISE_KEY` in Vercel to the current value generated by the Postman collection pre-request script. Redeploy after changing it.
