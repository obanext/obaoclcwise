...
const ROWS = [
  row({ label: "Aquabrowser metadata", rawXmlPath: "/aquabrowser/@version|@before-rendering-time|@total-time|@detail-level", rawJsonPath: "_attributes", mappedPath: "_attributes", oclcEndpoint: "", oclcField: "", transformation: "leeg laten", status: "na", note: "OCLC levert deze ABL-runtime metadata niet.", valueField: "unavailable" }),
  row({ label: "Request context", rawXmlPath: "/aquabrowser/meta/rctx", rawJsonPath: "meta.rctx._text", mappedPath: "meta.rctx._text", transformation: "leeg laten", status: "na", note: "Niet beschikbaar uit OCLC.", valueField: "unavailable" }),
  row({ label: "ID", rawXmlPath: "/aquabrowser/id", rawJsonPath: "id._text", oclcEndpoint: "/discovery/title/{id}", oclcField: "id", mappedPath: "id._text", transformation: "direct", status: "direct", note: "OCLC/Wise titleId wordt rechtstreeks in id._text geplaatst.", valueField: "id" }),
  row({ label: "ID attributen", rawXmlPath: "/aquabrowser/id/@nativeid|@ds|@search-term", rawJsonPath: "id._attributes", oclcEndpoint: "/discovery/title/{id}", oclcField: "id", mappedPath: "id._attributes", transformation: "OCLC id in nativeid en search-term geplaatst", status: "direct", note: "Geen oude OBA-id opgebouwd; ds blijft leeg omdat OCLC hiervoor geen bronwaarde levert.", valueField: "id" }),
  row({ label: "FRABL", rawXmlPath: "/aquabrowser/frabl", rawJsonPath: "frabl._text", oclcEndpoint: "/discovery/title/{id}", oclcField: "frbrkey|frbrKey", mappedPath: "frabl._text", transformation: "OCLC FRBR-id in frabl-contractobject geplaatst", status: "direct", note: "Dit is de OCLC FRBR-id; geen oude ABL hex-waarde wordt opgebouwd.", valueField: "frbrkey" }),
  row({ label: "Detailpagina URL", rawXmlPath: "/aquabrowser/detail-page", rawJsonPath: "detail-page._text", oclcEndpoint: "/discovery/title/{id}", oclcField: "id", mappedPath: "detail-page._text", transformation: "interne mockup-link opgebouwd uit de OCLC id", status: "afgeleid", note: "Interne link naar /oba-detail/{id}; geen oude zoeken.oba.nl URL.", valueField: "id" }),
  ...
  row({ label: "ISBN", rawXmlPath: "/aquabrowser/identifiers/isbn-id", rawJsonPath: "identifiers.isbn-id", oclcEndpoint: "/discovery/title/{id}", oclcField: "isbn[]", mappedPath: "identifiers.isbn-id", transformation: "waarde in identifier-object geplaatst", status: "direct", note: "De OCLC ISBN-waarde blijft ongewijzigd.", valueField: "isbn[]" }),
  ...
  row({ label: "Undup-info", rawXmlPath: "/aquabrowser/undup-info", rawJsonPath: "undup-info", oclcEndpoint: "/discovery/title/{id}", oclcField: "frbrkey|childTitleList[]|title|author.description", mappedPath: "undup-info", transformation: "contractobject samengesteld uit beschikbare OCLC groepsgegevens", status: "afgeleid", note: "Geen oude OBA-id of oude zoeklink wordt opgebouwd.", valueField: "undup.info" }),
  ...
  row({ label: "Volgende verantwoordelijken", rawXmlPath: "/aquabrowser/librarian-info/record/marc/df200/df200[@key='g']", rawJsonPath: "librarian-info.record.marc.df200.df200[key=g]._text", oclcEndpoint: "/discovery/title/{id}", oclcField: "collaborators[].description", mappedPath: "librarian-info.record.marc.df200.df200[key=g]._text", transformation: "meerdere OCLC waarden samengevoegd", status: "afgeleid", note: "Geen 'met illustraties van' of 'tekeningen' tekst toevoegen.", valueField: "collaborators.description" }),
  ...
  row({ label: "Beschikbaarheid view", rawXmlPath: "niet in raw XML contract als los statusveld", rawJsonPath: "raw.itemInformation[].effectiveStatus", oclcEndpoint: "/title/{id}/iteminformation", oclcField: "effectiveStatus", mappedPath: "raw.itemInformation[].effectiveStatus", transformation: "direct voor view", status: "direct", valueField: "item.status" }),
  row({ label: "Titelbeschikbaarheid/reserveren", rawXmlPath: "geen directe ABL-equivalent in mapped detailcontract", rawJsonPath: "raw.availability", oclcEndpoint: "/branch/1000/titleavailability/{id}?clientType=PUBLIC&holdsCount=true", oclcField: "availability[].status|holdAllowed|holdQueuePosition", mappedPath: "raw.availability", transformation: "direct voor debug/view", status: "direct", valueField: "availability.status" }),
];
